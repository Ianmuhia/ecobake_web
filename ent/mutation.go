...
// FavouritesMutation represents an operation that mutates the Favourites nodes in the graph.
type FavouritesMutation struct {
	config
	op             Op
	typ            string
	id             *int
	...
	oldValue       func(context.Context) (*Favourites, error)
	predicates     []predicate.Favourites
}

var _ ent.Mutation = (*FavouritesMutation)(nil)

// favouritesOption allows management of the mutation configuration using functional options.
type favouritesOption func(*FavouritesMutation)

// newFavouritesMutation creates new mutation for the Favourites entity.
func newFavouritesMutation(c config, op Op, opts ...favouritesOption) *FavouritesMutation {
	m := &FavouritesMutation{
		config:        c,
		op:            op,
		typ:           TypeFavourites,
		clearedFields: make(map[string]struct{}),
...
// withFavouritesID sets the ID field of the mutation.
func withFavouritesID(id int) favouritesOption {
	return func(m *FavouritesMutation) {
		var (
			err   error
			once  sync.Once
			value *Favourites
		)
		m.oldValue = func(ctx context.Context) (*Favourites, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().Favourites.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withFavourites sets the old Favourites of the mutation.
func withFavourites(node *Favourites) favouritesOption {
	return func(m *FavouritesMutation) {
		m.oldValue = func(context.Context) (*Favourites, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m FavouritesMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m FavouritesMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *FavouritesMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *FavouritesMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().Favourites.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *FavouritesMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *FavouritesMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the Favourites entity.
// If the Favourites object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FavouritesMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *FavouritesMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *FavouritesMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *FavouritesMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the Favourites entity.
// If the Favourites object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FavouritesMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearUpdatedAt clears the value of the "updated_at" field.
func (m *FavouritesMutation) ClearUpdatedAt() {
	m.updated_at = nil
	m.clearedFields[favourites.FieldUpdatedAt] = struct{}{}
}

// UpdatedAtCleared returns if the "updated_at" field was cleared in this mutation.
func (m *FavouritesMutation) UpdatedAtCleared() bool {
	_, ok := m.clearedFields[favourites.FieldUpdatedAt]
	return ok
}

// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *FavouritesMutation) ResetUpdatedAt() {
	m.updated_at = nil
	delete(m.clearedFields, favourites.FieldUpdatedAt)
}

// SetDeletedAt sets the "deleted_at" field.
func (m *FavouritesMutation) SetDeletedAt(t time.Time) {
	m.deleted_at = &t
}

// DeletedAt returns the value of the "deleted_at" field in the mutation.
func (m *FavouritesMutation) DeletedAt() (r time.Time, exists bool) {
	v := m.deleted_at
	if v == nil {
		return
	}
...
// OldDeletedAt returns the old "deleted_at" field's value of the Favourites entity.
// If the Favourites object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FavouritesMutation) OldDeletedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDeletedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearDeletedAt clears the value of the "deleted_at" field.
func (m *FavouritesMutation) ClearDeletedAt() {
	m.deleted_at = nil
	m.clearedFields[favourites.FieldDeletedAt] = struct{}{}
}

// DeletedAtCleared returns if the "deleted_at" field was cleared in this mutation.
func (m *FavouritesMutation) DeletedAtCleared() bool {
	_, ok := m.clearedFields[favourites.FieldDeletedAt]
	return ok
}

// ResetDeletedAt resets all changes to the "deleted_at" field.
func (m *FavouritesMutation) ResetDeletedAt() {
	m.deleted_at = nil
	delete(m.clearedFields, favourites.FieldDeletedAt)
}

// SetProductID sets the "product" edge to the Product entity by id.
func (m *FavouritesMutation) SetProductID(id int) {
	m.product = &id
}

// ClearProduct clears the "product" edge to the Product entity.
func (m *FavouritesMutation) ClearProduct() {
	m.clearedproduct = true
}

// ProductCleared reports if the "product" edge to the Product entity was cleared.
func (m *FavouritesMutation) ProductCleared() bool {
	return m.clearedproduct
}

// ProductID returns the "product" edge ID in the mutation.
func (m *FavouritesMutation) ProductID() (id int, exists bool) {
	if m.product != nil {
...
func (m *FavouritesMutation) ProductIDs() (ids []int) {
...
// ResetProduct resets all changes to the "product" edge.
func (m *FavouritesMutation) ResetProduct() {
	m.product = nil
	m.clearedproduct = false
}

// SetUserID sets the "user" edge to the User entity by id.
func (m *FavouritesMutation) SetUserID(id int) {
	m.user = &id
}

// ClearUser clears the "user" edge to the User entity.
func (m *FavouritesMutation) ClearUser() {
	m.cleareduser = true
}

// UserCleared reports if the "user" edge to the User entity was cleared.
func (m *FavouritesMutation) UserCleared() bool {
	return m.cleareduser
}

// UserID returns the "user" edge ID in the mutation.
func (m *FavouritesMutation) UserID() (id int, exists bool) {
	if m.user != nil {
		return *m.user, true
	}
	return
...
func (m *FavouritesMutation) UserIDs() (ids []int) {
	if id := m.user; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *FavouritesMutation) ResetUser() {
	m.user = nil
	m.cleareduser = false
}

// Where appends a list predicates to the FavouritesMutation builder.
func (m *FavouritesMutation) Where(ps ...predicate.Favourites) {
	m.predicates = append(m.predicates, ps...)
}

// Op returns the operation name.
func (m *FavouritesMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (Favourites).
func (m *FavouritesMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *FavouritesMutation) Fields() []string {
	fields := make([]string, 0, 3)
	if m.created_at != nil {
		fields = append(fields, favourites.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, favourites.FieldUpdatedAt)
	}
	if m.deleted_at != nil {
		fields = append(fields, favourites.FieldDeletedAt)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *FavouritesMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *FavouritesMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case favourites.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case favourites.FieldUpdatedAt:
	...
	return nil, fmt.Errorf("unknown Favourites field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *FavouritesMutation) SetField(name string, value ent.Value) error {
	switch name {
	case favourites.FieldCreatedAt:
		v, ok := value.(time.Time)
		if !ok {
	...
	return fmt.Errorf("unknown Favourites field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *FavouritesMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *FavouritesMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *FavouritesMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown Favourites numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *FavouritesMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(favourites.FieldUpdatedAt) {
		fields = append(fields, favourites.FieldUpdatedAt)
	}
	if m.FieldCleared(favourites.FieldDeletedAt) {
		fields = append(fields, favourites.FieldDeletedAt)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *FavouritesMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *FavouritesMutation) ClearField(name string) error {
	switch name {
	case favourites.FieldUpdatedAt:
		m.ClearUpdatedAt()
		return nil
	...
	return fmt.Errorf("unknown Favourites nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *FavouritesMutation) ResetField(name string) error {
	switch name {
	case favourites.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *FavouritesMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.product != nil {
		edges = append(edges, favourites.EdgeProduct)
	}
	if m.user != nil {
		edges = append(edges, favourites.EdgeUser)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *FavouritesMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case favourites.EdgeProduct:
		if id := m.product; id != nil {
			return []ent.Value{*id}
		}
	case favourites.EdgeUser:
		if id := m.user; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *FavouritesMutation) RemovedEdges() []string {
	edges := make([]string, 0, 2)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *FavouritesMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	}
	return nil
}
...
// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *FavouritesMutation) ClearedEdges() []string {
	edges := make([]string, 0, 2)
	if m.clearedproduct {
		edges = append(edges, favourites.EdgeProduct)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *FavouritesMutation) EdgeCleared(name string) bool {
	switch name {
	case favourites.EdgeProduct:
		return m.clearedproduct
	case favourites.EdgeUser:
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *FavouritesMutation) ClearEdge(name string) error {
	switch name {
	case favourites.EdgeProduct:
		m.ClearProduct()
		return nil
	...
	return fmt.Errorf("unknown Favourites unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *FavouritesMutation) ResetEdge(name string) error {
	switch name {
	case favourites.EdgeProduct:
		m.ResetProduct()
		return nil
	...
	return fmt.Errorf("unknown Favourites edge %s", name)
}
...
func (m *ProductMutation) SetFavouritesID(id int) {
	m.favourites = &id
}
...
// FavouritesCleared reports if the "favourites" edge to the Favourites entity was cleared.
func (m *ProductMutation) FavouritesCleared() bool {
	return m.clearedfavourites
}

// FavouritesID returns the "favourites" edge ID in the mutation.
func (m *ProductMutation) FavouritesID() (id int, exists bool) {
	if m.favourites != nil {
		return *m.favourites, true
	}
	return
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// FavouritesID instead. It exists only for internal usage by the builders.
func (m *ProductMutation) FavouritesIDs() (ids []int) {
	if id := m.favourites; id != nil {
		ids = append(ids, *id)
	}
	return
}
...
// RemoveFavouriteIDs removes the "favourites" edge to the Favourites entity by IDs.
...
// RemovedFavourites returns the removed IDs of the "favourites" edge to the Favourites entity.
